let world = [
    ...
    "USA",
    "ABE",
    "Almaty (Alma Ata) - Almaty International Airport",
    "Kazakhstan",
    "ALA",
    "Almeria",
    "Spain",
    ...
    "Jordan",
    "AMM",
    "Amman - Amman-Marka International Airport",
    "Jordan",
    "ADJ",
    "Amritsar",
    "India",
    ...
    "USA",
    "ANC",
    "Ancona - Ancona Falconara Airport",
    "Italy",
    "AOI",
    ...
    "Turkey",
    "AYT",
    "Antananarivo (Tanannarive) - Ivato International Airport",
    "Madagascar",
    "TNR",
    ...
    "Spain",
    "ACE",
    "Aruba - Reina Beatrix International, Oranjestad",
    "Aruba",
    "AUA",
    "Asheville (NC)",
    "USA",
    "AVL",
    "Ashgabat - Saparmurat Turkmenbashy Int. Airport",
    "Turkmenistan",
    "ASB",
    "Asmara - Asmara International",
    "Eritrea",
    "ASM",
    "Aspen, (CO) - Aspen-Pitkin County Airport",
    "USA",
    "ASE",
    "Assiut",
    "Egypt",
    ...
    "Kazakhstan",
    "TSE",
    "Asuncion - Asunción International Airport",
    "Paraguay",
    "ASU",
    "Aswan - Daraw Airport",
    "Egypt",
    ...
    "USA",
    "ATO",
    "Atlanta (GA) - Hartsfield Atlanta International Airport",
    "USA",
    "ATL",
    ...
    "New Zealand",
    "AKL",
    "Augsburg - Augsbur gAirport",
    "Germany",
    "AGB",
    "Augusta (GA)",
    "USA",
    "AGS",
    "Augusta (ME) - Augusta State Airport",
    "USA",
    "AUG",
    "Aurillac",
    "France",
    "AUR",
    "Austin (TX) - Austin-Bergstrom Airport",
    "USA",
    "AUS",
    "Ayawasi",
    "Indonesia",
    ...
    "India",
    "IXB",
    "Bahamas - Lynden Pindling International Airport",
    "The Bahamas",
    "NAS",
    "Bahawalpur",
    "Pakistan",
    ...
    "Australia",
    "BNK",
    "Baltimore (MD) - Washington International Airport",
    "USA",
    "BWI",
    "Bamaga",
    "Australia",
    ...
    "Central African Republic",
    "BGF",
    "Banjul - Banjul International Airport (Yundum International)",
    "Gambia",
    "BJL",
    "Bannu",
    "Pakistan",
    ...
    "India",
    "BDQ",
    "Barra (the famous tidal beach landing)",
    "United Kingdom",
    "BRR",
    "Barranquilla",
    "Colombia",
    ...
    "Iraq",
    "BSR",
    "Basse-Terre - Pointe-à-Pitre International Airport",
    "Guadeloupe",
    "PTP",
    ...
    "France",
    "BIA",
    "Baton Rouge (LA) - Baton Rouge Metropolitan Airport",
    "USA",
    "BTR",
    ...
    "USA",
    "BKW",
    "Beef Island - Terrance B. Lettsome",
    ...
    "Germany",
    "TXL",
    "Berlin, Tempelhof (ceased operating in 2008)",
    "Germany",
    "THF",
    ...
    "Kyrgyzstan",
    "FRU",
    "Bismarck (ND) - Bismarck Municipal Airport",
    "USA",
    "BIS",
    "Bissau - Osvaldo Vieiro International Airport",
    "Guinea-Bissau",
    "BXO",
    "Blackpool",
    "United Kingdom",
    ...
    "Australia",
    "BLT",
    "Blantyre (Mandala) - Chileka International Airport",
    "Malawi",
    "BLZ",
    "Blenheim",
    "New Zealand",
    ...
    "Turkey",
    "BJV",
    "Bogota - El Nuevo Dorado International Airport",
    "Colombia",
    "BOG",
    ...
    "Italy",
    "BLQ",
    "Bombay (Mumbai) - Chhatrapati Shivaji International",
    "India",
    "BOM",
    "Bonaire",
    ...
    "Australia",
    "BMP",
    "Brasilia - President Juscelino Kubitschek International",
    "Brazil",
    "BSB",
    ...
    "Congo (ROC)",
    "BZV",
    "Bremen - Bremen Airport (Flughafen Bremen)",
    "Germany",
    "BRE",
    "Brescia, Montichiari",
    "Italy",
    ...
    "Chile",
    "CJC",
    "Calcutta (Kolkata) - Netaji Subhas Chandra",
    "India",
    "CCU",
    ...
    "France",
    "CEQ",
    "Canouan (island) - Canouan Airport",
    ...
    "French Guiana",
    "CAY",
    "Cottbus - Cottbus-Drewitz Airport",
    "Germany",
    "CBU",
    "Cebu City - Mactan-Cebu International",
    "Philippines",
    "CEB",
    "Cedar City (UT)",
    "USA",
    ...
    "Greece",
    "CHQ",
    "Chaoyang, Beijing - Chaoyang Airport",
    "PR China",
    "CHG",
    "Charleston (SC)",
    "USA",
    ...
    "India",
    "MAA",
    "Cheyenne (WY) - Cheyenne Regional Airport",
    "USA",
    "CYS",
    ...
    "Zambia",
    "CIP",
    "Chisinau - Chişinău International Airport",
    "Moldova",
    "KIV",
    "Chita (Tschita)",
    "Russia",
    ...
    "Cuba",
    "CFG",
    "Cincinnati (OH) - Cincinnati/Northern Kentucky Int'l",
    "USA",
    "CVG",
    "Ciudad Del Carmen",
    "Mexico",
    ...
    "Australia",
    "KCE",
    "Cologne - Cologne Airport (Flughafen Köln/Bonn)",
    "Germany",
    "CGN",
    ...
    "USA",
    "COS",
    "Columbia (SC) - Columbia Metropolitan Airport",
    "USA",
    "CAE",
    "Columbus (GA)",
    "USA",
    ...
    "Algeria",
    "CZL",
    "Constanta (Constanța) - Constanta Int'l Airport",
    "Romania",
    "CND",
    "Coober Pedy",
    "Australia",
    ...
    "Mexico",
    "CUL",
    "Curacao - Curaçao International Airport",
    "Netherlands Antilles",
    "CUR",
    ...
    "USA",
    "DAN",
    "Dar es Salam (Daressalam) - Julius Nyerere Int'l",
    "Tanzania",
    "DAR",
    "Darwin",
    "Australia",
    ...
    "USA",
    "DSM",
    "Detroit (MI) , Coleman A. Young Municipal",
    "USA",
    "DET",
    "Detroit (MI) , Wayne County Airport",
    "USA",
    "DTW",
    ...
    "Bangladesh",
    "DAC",
    "Dili - Nicolau Lobato International Airport",
    ...
    "USA",
    "DBQ",
    "Duesseldorf - Düsseldorf International Airport",
    "Germany",
    "DUS",
    ...
    "South Africa",
    "DUR",
    "Dushanbe (Duschanbe) - Dushanbe Airport",
    "Tajikistan",
    "DYU",
    "Dutch Harbor (AK)",
    "USA",
    ...
    "USA",
    "FNT",
    "Florence (Firenze) - Peretola Airport",
    "Italy",
    "FLR",
    "Florence (SC)",
    "USA",
    ...
    "Brazil",
    "FOR",
    "Fort de France - Martinique Aimé Césaire International",
    "Martinique",
    "FDF",
    "Fort Dodge IA",
    "USA",
    ...
    "Canada",
    "YMM",
    "Fort Myers, Metropolitan Area (FL)",
    "USA",
    "FMY",
    "Fort Myers, Southwest Florida Reg (FL)",
    "USA",
    "RSW",
    "Fort Riley (KS) - Marshall AAF",
    "USA",
    "FRI",
    "Fort Smith",
    "Canada",
    ...
    "USA",
    "FWA",
    "Fort Worth (TX) - Dallas/Fort Worth International Airport",
    "USA",
    "DFW",
    "Foula (Shetland)",
    "United Kingdom",
    ...
    "Botswana",
    "FRW",
    "Frankfurt/Main - Frankfurt Airport (Rhein-Main-Flughafen)",
    "Germany",
    "FRA",
    "Frankfurt/Hahn",
    "Germany",
    ...
    "USA",
    "FAT",
    "Friedrichshafen - Bodensee-Airport Friedrichshafen",
    "Germany",
    "FDH",
    "Fuerteventura",
    "Spain",
    ...
    "Cameroon",
    "GOU",
    "Gaza City - Gaza International Airport",
    ...
    "USA",
    "GCN",
    "Grand Cayman - Owen Roberts International",
    "Cayman Islands",
    "GCM",
    "Grand Forks (ND)",
    "USA",
    ...
    "USA",
    "GSP",
    "Grenada - Point Salines Airport also Maurice Bishop",
    "Grenada",
    "GND",
    "Grenoble",
    "France",
    ...
    "Guam",
    "GUM",
    "Guangzhou (Canton) - Baiyun International Airport",
    "Guangdong, PR China",
    "CAN",
    ...
    "USA",
    "HRL",
    "Harrington Harbour, PQ",
    "Canada",
    "YHR",
    "Harrisburg (PA) - Harrisburg Skyport",
    "USA",
    "HAR",
    ...
    "Norway",
    "HAU",
    "Havana - José Martí International",
    "Cuba",
    "HAV",
    "Havre (MT)",
    "USA",
    ...
    "Greece",
    "HER",
    "Hermosillo - Gen. Pesqueira Garcia",
    "Mexico",
    "HMO",
    "Hervey Bay",
    "Australia",
    ...
    "Japan",
    "HIJ",
    "Ho Chi Minh City (Saigon) - Tan Son Nhat International",
    "Viet Nam",
    "SGN",
    "Hobart",
    "Australia",
    ...
    "Hong Kong",
    "ZJK",
    "Honiara Henderson International",
    "Solomon Islands",
    "HIR",
    ...
    "USA",
    "JAC",
    "Jackson (MI) - Reynolds Municipal",
    "USA",
    "JXN",
    "Jackson,  MN  ",
    "USA",
    "MJQ",
    "Jackson (MS) - Jackson Internationall",
    "USA",
    "JAN",
    "Jackson (MS) - Hawkins Field   ",
    "USA",
    "HKS",
    "Jackson (TN) - Mckellar",
    "USA",
    ...
    "USA",
    "JAC",
    "Jacksonville (AR)  Little Rock AFB   ",
    "USA",
    "LRF",
    "Jacksonville (FL) - Cecil Field NAS   ",
    "USA",
    "NZC",
    "Jacksonville (FL) Jacksonville NAS   ",
    "USA",
    "NIP",
    "Jacksonville (FL) - International",
    "USA",
    "JAX",
    "Jacksonville (FL) - Craig Municipal   ",
    "USA",
    "CRG",
    "Jacksonville (IL) - Municipal Airport",
    "USA",
    "IJX",
    "Jacksonville (NC)",
    "USA",
    ...
    "Saudi Arabia",
    "JED",
    "Jefferson City (MO) - Jefferson Memorial",
    "USA",
    "JEF",
    "Jeremie - Jeremie Airport",
    "Haiti",
    "JEE",
    "Jerez de la Frontera/Cadiz - La Parra",
    "Spain",
    "XRY",
    "Jersey",
    "Channel Islands",
    "JER",
    "Jerusalem - Atarot Airport (closed)",
    "Israel",
    "JRS",
    ...
    "Brazil",
    "JCB",
    "Joao Pessoa - Castro Pinto Airport",
    "Brazil",
    "JPA",
    "Jodhpur",
    "India",
    "JDH",
    "Jönköping (Jonkoping) - Axamo Airport",
    "Sweden",
    "JKG",
    "Joensuu",
    "Finland",
    ...
    "South Africa",
    "JNB",
    "Johnson City (NY) - Binghamton/Endicott/Johnson",
    "USA",
    "BGM",
    "Johnston Island",
    "USA",
    ...
    "USA",
    "JST",
    "Johor Bahru - Sultan Ismail International",
    "Malaysia",
    "JHB",
    "Joinville - Cubatao Airport",
    "Brazil",
    "JOI",
    "Jolo",
    "Philippines",
    ...
    "Nepal",
    "JMO",
    "Jonesboro (AR)  Jonesboro Airport",
    "USA",
    "JBR",
    "Joplin (MO)",
    "USA",
    ...
    "Germany",
    "JUI",
    "Juiz De Fora - Francisco De Assis Airport",
    "Brazil",
    "JDF",
    "Jujuy - El Cadillal Airport",
    "Argentina",
    "JUJ",
    "Julia Creek",
    "Australia",
    ...
    "Australia",
    "JUN",
    "Juneau (AK) - Juneau International Airport",
    "USA",
    "JNU",
    "Junin",
    "Argentina",
    ...
    "USA",
    "ENA",
    "Kent (Manston) Kent International",
    "United Kingdom",
    "MSE",
    "Kerry County",
    "Ireland",
    ...
    "Congo (DRC)",
    "FIH",
    "Kiritimati (island) - Cassidy International Airport",
    "Kiribati",
    "CXI",
    "Kirkenes",
    "Norway",
    ...
    "Finland",
    "KOK",
    "Kolkata (Calcutta) - Netaji Subhas Chandra",
    "India",
    "CCU",
    "Komatsu",
    "Japan",
    ...
    "USA",
    "LIJ",
    "Long Island, Islip (NY) - Mac Arthur",
    "USA",
    "ISP",
    "Longreach",
    "Australia",
    ...
    "Ukraine",
    "LWO",
    "Lydd - Lydd International Airport",
    "United Kingdom",
    "LYX",
    "Lynchburg (VA)",
    "USA",
    ...
    "France",
    "LYS",
    "Lyons (KS) - Rice County Municipal",
    "USA",
    "LYO",
    "",
    "M",
    ...
    "Netherlands",
    "MST",
    "Macapa - Alberto Alcolumbre International Airport",
    "Brazil",
    "MCP",
    ...
    "Philippines",
    "NOP",
    "Madinah (Medina) - Mohammad Bin Abdulaziz",
    "Saudi Arabia",
    "MED",
    "Madison (WI) - Dane County Regional Airport",
    "USA",
    "MSN",
    "Madras (Chennai) - Chennai International Airport",
    "India",
    "MAA",
    ...
    "USA",
    "MHT",
    "Mandalay - Mandalay-Annisaton Airport",
    "Myanmar",
    "MDL",
    "Manguna",
    "Papua New Guinea",
    ...
    "Mexico",
    "ZLO",
    "Manzini - Matsapha International",
    "Swaziland",
    "MTS",
    "Maputo - Maputo International",
    "Mozambique",
    "MPM",
    "Mar del Plata",
    "Argentina",
    ...
    "Australia",
    "MBH",
    "Maseru - Moshoeshoe International",
    "Lesotho",
    "MSU",
    "Mason City IA",
    "USA",
    ...
    "French Polynesia",
    "MAU",
    "Mauritius - S.Seewoosagur Ram International",
    "Mauritius",
    "MRU",
    "Mayaguez",
    "Puerto Rico",
    ...
    "USA",
    "MFE",
    "Medan - Polania Int'l (now Soewondo AFB)",
    "Indonesia",
    "MES",
    "Medan - Kualanamu International",
    "Indonesia",
    "KNO",
    "Medellin - José María Córdova International",
    "Colombia",
    "MDE",
    "Medford (OR)",
    "USA",
    ...
    "Australia",
    "MKR",
    "Melbourne - Melbourne Airport (Tullamarine)",
    "Australia",
    "MEL",
    "Melbourne (FL)",
    "USA",
    ...
    "France",
    "MZM",
    "Metz/Nancy Metz-Nancy-Lorraine",
    "France",
    "ETZ",
    "Mexicali",
    "Mexico",
    ...
    "USA",
    "MAF",
    "Midway Island - Sand Island Field",
    ...
    "USA",
    "MHE",
    "Miyako Jima (Ryuku Islands) - Hirara",
    "Japan",
    "MMY",
    "Miyazaki",
    "Japan",
    ...
    "Uruguay",
    "MVD",
    "Montgomery (AL) - Montgomery Regional Airport",
    "USA",
    "MGM",
    ...
    "Canada",
    "YMQ",
    "Montreal - Dorval (Montréal-Trudeau)",
    "Canada",
    "YUL",
    "Montreal - Mirabel",
    "Canada",
    ...
    "USA",
    "MCL",
    "Muenchen (Munich) - Franz Josef Strauss",
    "Germany",
    "MUC",
    "Muenster/Osnabrueck",
    "Germany",
    ...
    "Greece",
    "JMK",
    "Myrtle Beach (SC) - Myrtle Beach AFB",
    "USA",
    "MYR",
    "Myrtle Beach (SC) - Grand Strand Airport",
    "USA",
    "CRE",
    "Mysore",
    "India",
    ...
    "USA",
    "ACK",
    "Naples - Naples Capodichino Airport",
    "Italy",
    "NAP",
    "Naples (FL)",
    "USA",
    ...
    "Mexico",
    "NLD",
    "Nuku'alofa - Fua'Amotu International",
    "Tonga",
    "TBU",
    " ",
    "O",
    ...
    "Namibia",
    "OMD",
    "Oranjestad - Reina Beatrix International",
    "Aruba",
    "AUA",
    "Orkney - Kirkwall",
    "United Kingdom",
    "KOI",
    "Orlando Metropolitan Area (FL)",
    "USA",
    "ORL",
    ...
    "Australia",
    "PBO",
    "Paramaribo - Zanderij International",
    "Suriname",
    "PBM",
    "Paris",
    "France",
    ...
    "Poland",
    "POZ",
    "Prague - Václav Havel Airport (formerly Ruzyne)",
    "Czech Republic",
    "PRG",
    ...
    "India, Maharashtra",
    "PNQ",
    "Punta Arenas - Presidente Carlos Ibáñez del Campo",
    "Chile",
    "PUQ",
    "Punta Cana - Punta Cana International",
    "Dominican Republic",
    "PUJ",
    "Pu San (Busan) - Gimhae International Airport",
    "South Korea",
    "PUS",
    ...
    "Pakistan",
    "SDT",
    "Saigon (Ho Chi Minh City) - Tan Son Nhat International",
    "Viet Nam",
    "SGN",
    "Saint Brieuc",
    "France",
    ...
    "Argentina",
    "BRC",
    "San Diego - Lindberg Field International (CA)",
    "USA",
    "SAN",
    "San Francisco - International Airport, SA",
    "USA",
    "SFO",
    "San Jose Cabo",
    "Mexico",
    ...
    "Spain",
    "EAS",
    "Sanaa (Sana'a) - Sana'a International",
    "Yemen",
    "SAH",
    "Sandspit",
    "Canada",
    "YZP",
    "Santa Ana - John Wayne Airport (CA)",
    "USA",
    "SNA",
    "Santa Barbara (CA)",
    "USA",
    ...
    "Dominican Republic",
    "SDQ",
    "Sao Luis - Marechal Cunha Machado International",
    "Brazil",
    "SLZ",
    "Sao Paulo",
    "Brazil",
    ...
    "Finland",
    "SVL",
    "Scarborough - Crown Point International",
    "Trinidad and Tobago",
    "TAB",
    "Scone",
    "Australia",
    ...
    "United Kingdom",
    "DSA",
    "Shenandoah Valley/Stauton (VA)",
    "USA",
    "SHD",
    "Shenyang",
    "Liaoning, PR China",
    "SHE",
    "Shenzhen - Shenzhen Bao'an International",
    "Guangdong, PR China",
    "SZX",
    "Sheridan (WY)",
    "USA",
    ...
    "SFG",
    "St. Petersburg (Leningrad) - Pulkovo",
    "Russia",
    "LED",
    "St. Pierre, NF",
    "Canada",
    ...
    "Brazil",
    "UBA",
    "Uberlandia - Eduardo Gomes Airport",
    "Brazil",
    "UDI",
    "Ubon Ratchathani - Muang Ubon Airport",
    "Thailand",
    "UBP",
    ...
    "Angola",
    "UGO",
    "Ujung Pandang - Hasanudin Airport",
    "Indonesia",
    "UPG",
    "Ukhta",
    "Russia",
    ...
    "USA",
    "UKI",
    "Ulaanbaatar - Buyant Uhaa Airport",
    "Mongolia",
    "ULN",
    "Ulan-Ude",
    "Russia",
    ...
    "Saint Vincent and the Grenadines",
    "UNI",
    "Unst (Shetland Island) - Baltasound Airport",
    "United Kingdom",
    "UNT",
    "Upala",
    "Costa Rica",
    "UPL",
    "Upernavik - Upernavik Heliport",
    "Greenland",
    "JUV",
    "Upington",
    "South Africa",
    ...
    "Mexico",
    "UPN",
    "Urubupunga - Ernesto Pochler Airport",
    "Brazil",
    "URB",
    ...
    "Afghanistan",
    "URZ",
    "Ushuaia - Islas Malvinas Airport",
    "Argentina",
    "USH",
    "Utapao (Pattaya)",
    "Thailand",
    ...
    "Poland",
    "WAW",
    "Washington DC - Baltimore Washington International",
    "USA",
    "BWI",
    ...
    "Australia",
    "WHM",
    "Wien (Vienna) - Vienna International",
    "Austria",
    "VIE",
    "Wiesbaden, Air Base",
    "Germany",
  ...
  for (let i = 0 ;  i < world.length ; i = i + 3){
     cities.push(world[i]);
  ...
  for (let i = 1 ;  i < world.length ; i = i + 3){
     countries.push(world[i]);
  ...
  for (let i = 2 ;  i < world.length ; i = i + 3){
     codes.push(world[i]);
